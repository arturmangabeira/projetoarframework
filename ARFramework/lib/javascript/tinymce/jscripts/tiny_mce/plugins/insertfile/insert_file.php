...
//        <script type="text/javascript" src="../../dialog.js"></script>
        ...
        /*<![CDATA[*/
                ...
                function onOK() {
					 if (window.opener) {
						 var required = {
						 "f_url": "<?php echo $MY_MESSAGES['f_url'];?>",
						 "f_caption": "<?php echo $MY_MESSAGES['f_caption'];?>"
						 };
					...
					/*EVA - RCMS*/
					if (window.opener.filebrowser.type && window.opener.filebrowser.ok){
						//funciona para chamada via botao do formulario
						if (typeof window.opener.filebrowser.win.document == "undefined"){
							window.opener.parent.document.getElementById(window.opener.filebrowser.form_id).elements[window.opener.filebrowser.field_name].value = f_url;
						}else{
							//funciona para a chamada via tinymce, popup flash
							window.opener.filebrowser.win.document.forms[0].elements[window.opener.filebrowser.field_name].value = f_url;						
						}
						window.opener.filebrowser.ok = false;
						top.close();
                 		return false;
					}
          ...
          <tr>
            <td>
             <input id="f_addicon" value="f_addicon" type="checkbox" />
                                ...
                                <div align="left"><?php echo $MY_MESSAGES['inserticon']; ?></div>
                        </td>
                       <td>
                               <input id="f_addsize" value="f_addsize" type="checkbox" />
            </td><td>
                                <div align="left"><?php echo $MY_MESSAGES['insertsize']; ?></div>
                        </td>
                       <td>
                               <input id="f_adddate" value="f_adddate" type="checkbox" />
            </td><td>
                                <div align="left"><?php echo $MY_MESSAGES['insertdate']; ?></div>
                        </td>
                  </tr>
      </table>
