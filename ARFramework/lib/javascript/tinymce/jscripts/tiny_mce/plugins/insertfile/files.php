...
function createFolder() {
        ...
        $Folder = removeAcentos($Folder);
        $Folder = preg_replace('/[^\w\._]/', '_', $Folder);//substitui caracteres especiais
...
function renameFile() {
        ...
        if (isset($_REQUEST['folders']) && is_array($_REQUEST['folders'])) {
            foreach ($_REQUEST['folders'] as $file) {
                        ...
                        $newname = removeAcentos($newname);
                        $newname = preg_replace('/[^\w\._]/', '_', $newname);//substitui caracteres especiais
...
function uploadFile() {
        ...
        $filename = removeAcentos($filename);
        $filename = preg_replace('/[^\w\._]/', '_', $filename);//substitui caracteres especiais
