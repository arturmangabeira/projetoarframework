...
$eva['config']['url'] = (substr($eva['config']['url'],-1) != "/")? $eva['config']['url']."/" : $eva['config']['url'];
$config['galeria'] =  (isset($config['galeria']) && trim($config['galeria']) != "")? $config['galeria']:'GD';
$config['galeria_miniatura'] = (isset($config['galeria_miniatura']) && intval($config['galeria_miniatura']) > 0)? $config['galeria_miniatura']:96;
...
*/
$IMConfig['base_dir'] = "../../../../../../".$config['imagem'].$_SESSION['diretorio_arquivos'];
/*
...
*/
$IMConfig['base_url'] = $eva['config']['url'].$config['imagem'].$_SESSION['diretorio_arquivos'];
// $IMConfig['base_url'] = $config['imagem'];
/*
...
*/
define('IMAGE_CLASS', $config['galeria']);
...
*/
define('IMAGE_TRANSFORM_LIB_PATH', $config['galeria_path']);
...
*/
$IMConfig['thumbnail_width'] = $config['galeria_miniatura'];
$IMConfig['thumbnail_height'] = $config['galeria_miniatura'];
