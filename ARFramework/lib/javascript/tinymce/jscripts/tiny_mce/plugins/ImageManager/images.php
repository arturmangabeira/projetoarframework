...
function drawDirs($list, &$manager) 
{
	...
	{ ?>
		...
		<td class="edit">
			<a href="images.php?dir=<?php echo $relative; ?>&amp;deld=<?php echo rawurlencode($path); ?>" title="Lixeira" onClick="return confirmDeleteDir('<?php echo $dir['entry']; ?>', <?php echo $dir['count']; ?>);"><img src="img/edit_trash.gif" height="15" width="15" alt="Lixeira"/></a>
			<?php echo $dir['entry']; ?>
		</td>
		</tr></table></td>
	  <?php } //foreach
...
<table width="100%">
  <tr>
    <td class="noResult">Nenhuma imagem encontrada.</td>
  </tr>
</table>
<?php }
...
<table width="100%">
  <tr>
    <td class="error">Diretório inválido: <?php echo $manager->config['base_dir']; ?></td>
  </tr>
</table>
<?php }
...
<?php //we need to refesh the drop directory list
