...
<script type="text/javascript" src="lang/<?php echo $config['idioma_padrao']?>.js"></script>
<link rel="stylesheet" type="text/css" href="../../../themes/advanced/css/editor_popup.css" />
<style type="text/css">
body {
	margin: 0px;
}
...
/*<![CDATA[*/
	...
	if(ImageManager.I18N)
		I18N = ImageManager.I18N;
	/*
	if(window.top)
		I18N = window.top.I18N;
	if(window.opener){
		if(window.opener.ImageManager)
...
<!-- image properties -->
	<table class="inputTable">
		<tr>
			...
			<td><input type="text" id="f_vert" class="smallWidth" value="0" style="width:20px" /></td>
		</tr>		
		<tr>
			...
			<td><input type="text" id="f_horiz" class="smallWidth" value="0" style="width:20px" /></td>
		</tr>
		<tr>
...
<?php } ?>
			...
			<td><input type="text" id="f_border" class="smallWidth" value="0" style="width:20px" /></td>
		</tr>
		<tr> 
