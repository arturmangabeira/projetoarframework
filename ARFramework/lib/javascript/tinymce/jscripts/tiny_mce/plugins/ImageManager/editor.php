...
<div id="contents">
<!-- /*EVA*/ -->
<iframe src="editorFrame.php?img=<?php if(isset($_GET['img'])) echo rawurlencode(str_replace("%2F", "/", $_GET['img'])); ?>" name="editor" id="editor"  scrolling="auto" title="Image Editor" frameborder="0"></iframe>
</div>
<div id="bottom"></div>
</body>
</html>
