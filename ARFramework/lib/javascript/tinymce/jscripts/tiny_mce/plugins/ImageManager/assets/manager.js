	...
	function onOK() 
	{
		...
		*/
		if (window.opener.tinyMCE) {
			var src    = makeURL(base_url,document.getElementById("f_url").value);
			...
			//window.opener.tinyMCE.execCommand('mceInsertContent',false,'<img src=&quot;'+src+'&quot; alt=&quot;'+alt+'&quot; width=&quot;'+width+'&quot; height=&quot;'+height+'&quot; />');
			window.opener.tinyMCE.themes['advanced']._insertImage(src, alt, border, hspace, vspace, width, height, align, title);
			top.close();
			return false;
		}	
		// pass data back to the calling window
