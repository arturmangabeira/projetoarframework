...
class LoginAlterar extends Page {
    ...
    public function alterarSenha(){
    	...
    	if($_REQUEST["dsSenhaNovaAux"] == $_REQUEST["dsSenhaNova"]){
    		...
    		$resultado = 1;
    		if($resultado == 1){
    			ARMessage::showMessage("Senha atuzalizada com sucesso!. Vocè será redirecionado para a tela de login do sistema!",ARMessageType::ERRO,"","index.php?modules=login&acao=obter&cod_cliente={$codCliente}");
    		}
    	}else{
    ...
    public function cancelar(){
    	...
    	//ARMessage::showMessage("Testando a mesagem com ajaxForm!!",ARMessageType::AVISO,"","index.php?modules=login&acao=obter&cod_cliente={$codCliente}",0);
    }
}
