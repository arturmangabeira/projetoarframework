...
class ServicoMnt extends PageGrid{
	...
	public function salvar(){			
		...
		if(empty($_REQUEST["id_servico"])){				
			...
			ARMessage::showMessage("Serviço inserido com sucesso! Voce será redirecionado para a tela de listagem de serviços",ARMessageType::ERRO,"","index.php?modules=servico&acao=listar",1000);
			...
			ARMessage::showMessage("Serviço atualizado com sucesso! Voce será redirecionado para a tela de listagem de serviços",ARMessageType::ERRO,"","index.php?modules=servico&acao=listar",1000);	
