	...
	public function salvar(){			
		...
		if(empty($_REQUEST["id_cliente"])){
			...
			if($result->count() == 0){			
				...
				ARMessage::showMessage("Cliente inserido com sucesso! Voce será redirecionado para a tela de listagem do clientes",ARMessageType::ERRO,"","index.php?modules=configuracaocliente&acao=listar",1000);
			}else{
