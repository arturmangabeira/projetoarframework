...
//die();
if (empty($_SESSION["acessoLogin"]) && empty($_SESSION["cod_cliente"]) && $_REQUEST["modules"] != "admin") {
	...
	funcoes::redirecionar("index.php?modules=login&acao=obter&cod_cliente=".$cod_cliente);
}
