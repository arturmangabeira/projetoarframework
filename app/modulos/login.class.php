...
class Login extends Page {
    ...
    public function logar(){
        ...
        require_once 'modulos/servicosjt.class.php';
        ...
        if ($codLocador > 0 && $_SESSION['cap_code'] == $_REQUEST['dsCpt']){
            ...
            funcoes::redirecionar("index.php?modulos=login&acao=obter&cod_cliente={$retornoDto->getCod_Cliente()}","Não foi encontrado proprietário/locatário com o cpf/cnpj fornecido!");
        } 
        */       
    }
    ...
    public function logOut(){             
        ...
        if($_SESSION["acessoAdmin"] == "true"){
        	...
        	unset($_SESSION["acessoLogin"]); 
           	unset($_SESSION["acessoAdmin"]);
        	funcoes::redirecionar("index.php?modulos=admin");
        }else{
        	$codCliente = $_SESSION["codCliente"];
        	session_destroy();
        	unset($_SESSION["acessoLogin"]); 
